...
app.route('/addbook','post',manager.addBook);
app.route('/addbooknum','post',manager.addbooknum);
app.route('/redbooknum','post',manager.redbooknum);
app.route('/alterbook','post',manager.alterbook);
app.route('/searchbook','post',manager.searchbook);

app.route('/addreader','post',Reader.addreader);
app.route('/delreader','post',Reader.delreader);
app.route('/alterreader','post',Reader.alterreader);
app.route('/searchreader','post',Reader.searchreader);

app.route('/borrowlist','post',Borrow.borrowlist);
app.route('/borrowbook','post',Borrow.borrowbook);
app.route('/returnbook','post',Borrow.returnbook);
app.route('/outtimelist','*',Borrow.outtimelist);
